...
internal class TimeStoppedPlayer : TimeStoppedDynamicObjectBase
{
    ...
    public TimeStoppedPlayer(IPlayer player, IGame game, IEffectsPlayer effectsPlayer, IExtendedEvents extendedEvents,
        ...
        (_playerInstance, _player, _playerModifiersService) =
        (player, identityService.GetPlayerByInstance(player), playerModifiersService);
    ...
    protected override void InitializeInternal()
    {
        ...
        _playerInstance.SetInputMode(_playerInstance.IsBot ? PlayerInputMode.Disabled : PlayerInputMode.ReadOnly);
    ...
    protected override void ResumeTimeInternal()
    {
        ...
        _playerModifiersService.RevertModifiers(_player,
    ...
    private void OnMeleeAction(Event<IPlayer, PlayerMeleeHitArg[]> @event)
    {
        ...
        foreach (var meleeHit in meleeHits)
        {
            ...
            if (attacker is { IsMeleeAttacking: true, IsWalking: true } &&
                _playerInstance.CurrentWeaponDrawn != WeaponItemType.NONE)
            {
